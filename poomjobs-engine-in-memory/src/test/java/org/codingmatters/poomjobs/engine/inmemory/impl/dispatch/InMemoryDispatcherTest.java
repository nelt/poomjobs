...
public class InMemoryDispatcherTest {
    ...
    public void testDispatcherThreadStoppedWhenDispatcherGarbageCollected() throws Exception {
        ...
        JobQueueService queue = new MockedJobQueueService();

        InMemoryDispatcher dispatcher = new InMemoryDispatcher(store, queue);
        ...
        assertThat("dispatcher no garbage collected", dispatcherRef.get(), is(nullValue()));
